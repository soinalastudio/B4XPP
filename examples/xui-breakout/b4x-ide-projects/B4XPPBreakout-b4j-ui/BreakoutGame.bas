...
Sub Class_Globals
	Private mGameWidth As Float = 640
	Private mGameHeight As Float = 480
    Private xui As XUI
...
' B4X++ property: public GameWidth As Float default=640
Public Sub getGameWidth As Float
	Return mGameWidth
End Sub

Public Sub setGameWidth(B4XPP_GameWidth As Float)
	mGameWidth = B4XPP_GameWidth
End Sub

' B4X++ property: public GameHeight As Float default=480
Public Sub getGameHeight As Float
	Return mGameHeight
End Sub

Public Sub setGameHeight(B4XPP_GameHeight As Float)
	mGameHeight = B4XPP_GameHeight
End Sub
